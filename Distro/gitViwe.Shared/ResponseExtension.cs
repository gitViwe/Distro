...
namespace gitViwe.Shared
{
    ...
    public static class ResponseExtension
    {
        ...
        public static async Task<IResponse<TData>> ToResultAsync<TData>(this HttpResponseMessage response) where TData : class, new()
        {
        ...
        public static async Task<IResponse> ToResultAsync(this HttpResponseMessage response)
        {
            // get the response as a string
            var responseAsString = await response.Content.ReadAsStringAsync();
